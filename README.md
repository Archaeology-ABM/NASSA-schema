...
| title                | 0     |                 | Module name or title. Acronyms with no verbs are recommended.                                                                                                                                                                                                                   | String | free text, max. 50 characters                                                                                                                                        | true      |
...
| orcid                | 1     | contributors    | ORCID number of a contributor (if absent, authors should either create one or use a dummy place-holder number (e.g. 0000-0002-1825-0097)                                                                                                                                                                                                                                                   | String | 9999-9999-9999-9999                                                                                                                                                  | true     |
| license              | 0     |                 | Software license for the code in this module                                                                                                                                                                                                                                    | String | valid SPDX identifier (second column at https://spdx.org/licenses)                                                                                                   | false     |
| lastUpdateDate       | 0     |                 | Date of the last update submitted                                                                                                                                                                                                                                               | Date   | YYYY-MM-DD                                                                                                                                                           | true      |
| description          | 0     |                 | A concise but informative description of what the module does.                                                                                                                                                                                                                  | String | free text, max. 300 characters                                                                                                                                       | true      |
| coverImage           | 0     |                 | Path to an image file, preferably in the root of the module. Accepted formats: PNG, JPG, JPEG, SVG.                                                                                                                                                                              | String | path                                                                                                                                                                 | false     |
...
| softwareDependencies | 1     | implementations | Listing any software (libraries, packages, etc), specifying the release version, on which the module implementation relies to function properly.                                                                                                                                | Array  | free text                                                                                                                                                            | true      |
| docsDir              | 0     |                 | Relative path to the directory containing general module documentation.                                                                                                                                                                                                         | String | path                                                                                                                                                                 | false     |
| inputs               | 0     |                 | List of inputs required by the module. Create entries for each variable that can or should be externally set, ensuring the module functions properly.                                                                                                                        |        |                                                                                                                                                                      | false     |
